 ...
 */
    ...
    env.gui_3.svld.add( env, 'outputSetupFileName' ) ;
    env.gui_3.svld.add( env, 'saveSetupToXML') ;

    env.gui_3.svld.add( env.inputSetup, 'click').name('Load Setup from XML File') ;
...
function Environment(){
    ...
    this.solve       = function(){
        ...
        //if (env.running){
        //    env.canvasRecorder.resume() ;
        //}else{
        //    env.canvasRecorder.pause() ;
        //}
        return ;
    } ;
    this.time        = 0.0 ;
 ...
 */
    ...
    env.scriptInit = function(){
        if (env.scripting){
            /* SCRIPT INITIAL CONDITIONS */
            // FIXME: MAKE SURE THAT EVERYTHING IS CORRECTLY IMPLEMENTED
            switch (env.setNo){
                case 0 : /* control */
                    console.log('Control') ;
                    env.C_Na    = 1. ;
        ...
        // FIXME: CHANGE THE RANGE FOR THE PACEMAKER
        //if( env.paceMakerPeriod < 300 ){
        //    env.paceMakerConstantDi = true ;
        //    env.paceMakerDi         = 60. ;
        //    env.canvasRecorder.pause() ;
        //}else{
        //    env.paceMakerConstantDi = false ;
        //}
        ...
        env.noCDIs = 0 ;
        env.sampler.reset() ;
       // env.canvasRecorder.reset(); 
       // env.canvasRecorder.start() ;
    } ;
    ...
    env.scriptRun = function(){
        ...
        if ( env.setNo < env.sets.length ){
            // FIXME: CONSTANT DI PACING NEEDS FIXING 
            //if (    env.noCDIs > env.noRequiredCDIs 
            //    &&  env.paceMakerConstantDi         ){
            //    env.paceMakerConstantDi = false ;
            //    env.noCDIs  = 0 ;
            //    env.time    = 0 ;
            //    env.noAPDs  = 1 ;
